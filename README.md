...
```
### Source files
Source files are located in the Units and Translations folders.
```
.
├── Units/
│   ├── Vaccines/
...
### Generated files
Generated files are under the Release folder.
```
.
├── Release/
        ├── version
...
```
The Release folder contains a Version file that gives the Version, Edition and Iteration of the last generated RDF resources.
...
#### Alignments
These are the reference alignements of other code systems for administered vaccines with NUVA vaccine codes. There is one folder per code system.
